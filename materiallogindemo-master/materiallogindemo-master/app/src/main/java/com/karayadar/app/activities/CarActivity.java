...
import com.karayadar.app.SignupActivity;
...
public class CarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed_maker = findViewById(R.id.username_value);
        ed_model = findViewById(R.id.password_value);
        ed_color = findViewById(R.id.website_value);
        ed_rent = findViewById(R.id.notes_value);
        ed_desc = findViewById(R.id.description_value);
        ...
        findViewById(R.id.carimg).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!validate()) {
                    Toast.makeText(CarActivity.this, "Failed to upload", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        findViewById(R.id.carimg2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!validate()) {
                    Toast.makeText(CarActivity.this, "Failed to upload", Toast.LENGTH_SHORT).show();
        ...
        findViewById(R.id.savecar).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               file();
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 100 && resultCode == RESULT_OK && data != null) {
         ...
         //   Toast.makeText(this, "data"+selectedImage, Toast.LENGTH_SHORT).show();
         ...
         //   Toast.makeText(this, "data"+selectedImage2+"data"+selectedImage, Toast.LENGTH_LONG).show();
    ...
    private void file()
    {
        ...
        final String mobile = ed_color.getText().toString();
        ...
        uploadFile(selectedImage,selectedImage2, status, address, email, mobile, password, reEnterPassword, userid);
    }

    private void uploadFile(Uri fileUri,Uri fileUri2, String desc, String rent, String type, String duration, String color, String maker, String userid) {
        ...
        Call<ImageResponse> call = api.uploadImage(requestFile,requestFile2, Status, Model,Rent, Description, Color,Maker, Userid);
