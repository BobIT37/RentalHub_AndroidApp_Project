...
public class MyHouseListAdapter extends RecyclerView.Adapter<MyHouseListAdapter.UsersViewHolder> {
    ...
    public MyHouseListAdapter(Context mCtx, List<HouseModel> userList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(@NonNull final UsersViewHolder holder, final int position) {
        ...
        holder.textViewType.setText(itm.gethousestatus());
